...
export default function Customers() {
  const { customers, openForm } = useData()
          ...
          <table className="w-full min-w-[820px]">
            <thead>
              <tr className="bg-slate-50/60">
                ...
                <th className="th">Total Business</th><th className="th">Outstanding</th><th className="th">Status</th>
              </tr>
            </thead>
            <tbody>
              {rows.map((c) => (
                <tr key={c.id} className="hover:bg-slate-50/60">
                  ...
                  <td className="td font-semibold">{sar(c.business)}</td>
                  <td className="td">
