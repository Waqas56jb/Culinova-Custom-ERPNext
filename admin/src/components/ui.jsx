  ...
  return (
    <div className="card card-pad relative overflow-hidden animate-fade-up">
      ...
      <div className="flex items-start justify-between">
        ...
        {delta !== undefined && (
          <span className={`chip ${up ? 'bg-emerald-50 text-emerald-600' : 'bg-rose-50 text-rose-600'}`}>{up ? <TrendingUp size={13} /> : <TrendingDown size={13} />}{up ? '+' : ''}{delta}%</span>
        )}
      </div>
...
export const accessTone = { 'View Only': 'gray', Create: 'blue', Edit: 'amber', Approval: 'violet', 'Full Admin': 'green' }
